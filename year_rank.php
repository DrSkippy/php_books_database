...
$search_str = 'select year(b.ReadDate) as year, sum(a.Pages) as total '
$search_str .= 'from `book collection` as a, `books read` as b JOIN ON a.BookCollectionID=b.BookCollectionID '
