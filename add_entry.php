...
$insert_str = 'INSERT INTO `book collection` '.
    '(Title, Author, CopyrightDate, ISBNNumber, ISBNNumber13, PublisherName, '.
    'CoverType, Pages, LastRead, PreviouslyRead, Location, Note, Recycled) '.
    'VALUES ("'.$_REQUEST['title'].'","'.
     $_REQUEST['author'].'","'.date("Y-m-d h:m:s",$dt).'","'.
     $_REQUEST['isbnnumber'].'","'.
     $_REQUEST['isbnnumber13'].'","'.
     $_REQUEST['publishername'].'","'.
     $_REQUEST['covertype'].'","'.
     $_REQUEST['pages'].'",0000-00-00,0000-00-00,"'.
     $_REQUEST['location'].'","'.
     $_REQUEST['note'].'","'.$recycled.'")';
